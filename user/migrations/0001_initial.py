# Generated by Django 5.0.7 on 2024-12-30 09:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False)),
                ('date_joined', models.DateTimeField(auto_now_add=True)),
                ('groups', models.ManyToManyField(blank=True, related_name='regular_user_set', related_query_name='regular_user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='regular_user_set', related_query_name='regular_user', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
                'verbose_name': 'Regular User',
                'verbose_name_plural': 'Regular Users',
                'permissions': [('can_view_basic_info', 'Can view basic information')],
            },
        ),
    ]
